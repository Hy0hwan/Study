...
console.log('생성자 함수로 만든 유저 객체 : ', user);
...
console.log(member);
console.log(member.name); // marco -> 점 표기법으로 접근
console.log(member['job']); // office worker -> 대괄호 표기법으로 접근
...
console.log(userB.brother.name); // 유저 A
console.log(userB.brother['age']); // 100
